...
Функция ПолучитьСписокИсключений_Обработки() Экспорт
	...
	Результат.Добавить("РезервноеКопированиеИБ");
	Результат.Добавить("ПомощникИнтерактивногоОбменаДанными");
	Результат.Добавить("ВыполнениеОбменаДанными");
	Результат.Добавить("рцПечатьКвитанций");
	Результат.Добавить("ЗагрузкаКурсовВалют");
