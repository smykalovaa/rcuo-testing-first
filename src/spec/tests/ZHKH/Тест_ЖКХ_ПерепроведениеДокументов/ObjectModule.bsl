...
Процедура ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_Оплата() Экспорт
	...
	ТабДокДвиженийДо = ПолучитьТабДокументДвижений("ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_Оплата_СКД", "Оплата_До.XLSX");
	ОтменитьДвиженияДокументовПоСписку();
	ПерепровестиВсеДокументыПоСпискуДокументов_Оплата();
	ТабДокДвиженийПосле = ПолучитьТабДокументДвижений("ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_Оплата_СКД", "Оплата_После.XLSX");
	СравнитьТабличныеДокументыДвижений("Оплата");
