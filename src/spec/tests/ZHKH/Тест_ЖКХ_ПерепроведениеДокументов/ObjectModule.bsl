...
Процедура ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_НачисленияОДН() Экспорт
	...
	//ТабДокДвиженийДо = ПолучитьТабДокументДвижений("ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_Начисления_СКД");
	//ПерепровестиВсеДокументыПоСпискуДокументов();
	//ТабДокДвиженийПосле = ПолучитьТабДокументДвижений("ТестДолжен_ПерепровестиИСравнитьДвиженияДокументов_Начисления_СКД");
	//СравнитьТабличныеДокументыДвижений();
